...
func (m *MockShortLinkRepo) DeleteBatch(arg0 context.Context, arg1 []string, arg2 string) error {
	m.ctrl.T.Helper()
...
func (mr *MockShortLinkRepoMockRecorder) DeleteBatch(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteBatch", reflect.TypeOf((*MockShortLinkRepo)(nil).DeleteBatch), arg0, arg1, arg2)
}
